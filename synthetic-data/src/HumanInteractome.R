...
write_tsv(experiments_1, 'results/human_interactome-1.txt')
write_tsv(experiments_100, 'results/human_interactome-100.txt')
write_tsv(experiments_200, 'results/human_interactome-200.txt')
write_tsv(experiments_300, 'results/human_interactome-300.txt')
write_tsv(experiments_400, 'results/human_interactome-400.txt')
write_tsv(experiments_500, 'results/human_interactome-500.txt')
write_tsv(experiments_600, 'results/human_interactome-600.txt')
write_tsv(experiments_700, 'results/human_interactome-700.txt')
write_tsv(experiments_800, 'results/human_interactome-800.txt')
write_tsv(experiments_900, 'results/human_interactome-900.txt')
