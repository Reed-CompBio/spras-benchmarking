...
https://github.com/koksal/tps/blob/bb58d6d89e24dbc39e976a02f1e31387dbe17dfb/pcsf/generate_prizes.sh
"""
...
def CreateParser():
    ...
    parser = ArgumentParser(
        description="Compute peptide prizes from the TPS first and previous scores files and map them to protein prizes.  See the TPS readme for the expected file formats."
    )
    parser.add_argument(
        "--firstfile", type=str, dest="firstfile", help="The path and filename of the TPS firstscores file", default=None, required=True
    )
...
def main(arg_list):
    ...
    # multiple proteins if it maps to multiple proteins.
