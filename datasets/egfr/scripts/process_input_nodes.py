...
# TODO: Identify a programmatic way to generate this magic value. It has the constraints of:
# - PRIZE_VALUE > prizes.loc[:, "prize"].max()
# - not too big
# and this value experimentally was one that worked, but there are others that may work and would admit a more precise description
PRIZE_VALUE = 10
