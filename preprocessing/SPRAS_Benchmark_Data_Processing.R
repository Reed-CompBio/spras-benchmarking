...
setwd('~/Desktop/GitHub_Repos/spras-benchmarking/preprocessing/Beta3_adrenergic_rec/')
...
process_panther_pathway <- function(pathway_path) {
  ...
  return(list(edges = string_edges, edges_rm = edges_rm, nodes = nodes, nodes_rm = nodes_rm))
}

# Example usage:
pathway_path <- "Beta3_adrenergic_rec.txt"
